...
from storeApp.forms import FormComment, FormContact
...
def form_comment(request):
    ...
    return render(request, 'storeApp/form_comment.html', context = { 'form': form })
...
def form_contact(request):
    ...
    return render(request, 'storeApp/form_contact.html', context = { 'form': form })